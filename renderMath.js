...
function renderMath() {
    ...
    for (var h = 0; h < integralTags.length; h++) {
        ...
        integralTags[h].innerHTML = "<span style='font-size: 200%'>&int;</span><sub style='display: inline-block; transform: translateY(10px);'>" + lowerBound + "</sub><sup style='display: inline-block; transform: translateY(-20px);'>" + upperBound + "</sup><span style='transform: translateY(50px);'>" + integralTags[h].innerHTML + "</span>";
