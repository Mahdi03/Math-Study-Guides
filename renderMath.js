            ...
            ["pointermove"].forEach((eventName) => {
                this.canvas.addEventListener(eventName, (event) => {
                    if (this.drawFlag) {
                        ...
                        this.ctx.lineTo(this.currentX, this.currentY);
                        this.ctx.stroke();
                        this.addToActionHistory(`this.ctx.beginPath(); this.ctx.lineWidth = ${this.drawingStrokeWidth}; this.ctx.globalAlpha = ${this.opacityValue}; this.ctx.strokeStyle = "${this.colorValue}"; this.ctx.fillStyle = "${this.colorValue}"; this.ctx.moveTo(${this.previousX}, ${this.previousY}); this.ctx.lineTo(${this.currentX}, ${this.currentY}); this.ctx.stroke();`);
                    }
